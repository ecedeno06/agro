 ...
 */
export async function createSession(idUsuario, rolCodigo = null, idCapitulo = null) {
  ...
  await query(
    'INSERT INTO public.sesiones (token, id_usuario, rol_codigo, id_capitulo, expira_en) VALUES ($1, $2, $3, $4, $5)',
    [token, idUsuario, rolCodigo, idCapitulo ?? null, expiresAt.toISOString()]
  );
